...
# ==========================================
# GENERADOR DE MINIGRÁFICA DE BARRAS (PROPS BR L10)
# ==========================================
...
# ==========================================
# BASE DE DATOS Y JERSEYS: MLB COMPLETA
# ==========================================
JERSEYS_MLB = {
...
# ==========================================
# ESTILOS CSS CON BOTONES VERDE FLUORESCENTE RESPLANDECIONTE
# ==========================================
st.markdown("""
<style>
...
# ==========================================
# PANEL INFERIOR: TRACKER DIVIDIDO EN 3 FASES CON ELIMINACIÓN
# ==========================================
...
if len(historial_filtrado) == 0:
    ...
    with col_g1:
        ...
        fig_pie.update_layout(
            title=dict(text=f"Distribución ({filtro_dep})", font=dict(color='#f5d742')), 
            height=230, 
